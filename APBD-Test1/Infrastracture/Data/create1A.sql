...
ALTER TABLE Appointment_Service
    ADD CONSTRAINT Appointment_Service_Appointment
        FOREIGN KEY (appointment_id)
            REFERENCES Appointment (appointment_id);

-- Reference: Appointment_Service_Service (table: Appointment_Service)
ALTER TABLE Appointment_Service
    ADD CONSTRAINT Appointment_Service_Service
...
-- Doctors
INSERT INTO Doctor (doctor_id, first_name, last_name, PWZ)
VALUES (1, 'Anna', 'Kowalska', 'PWZ1234'),
       (2, 'Jan', 'Nowak', 'PWZ5678'),
       (3, 'Ewa', 'Wiśniewska', 'PWZ9012');

-- Patients
INSERT INTO Patient (patient_id, first_name, last_name, date_of_birth)
VALUES (1, 'Michał', 'Zieliński', '1990-03-15'),
...
-- Services
INSERT INTO Service (service_id, name, base_fee)
VALUES (1, 'Consultation', 100.00),
       (2, 'Blood Test', 50.00),
       (3, 'X-Ray', 120.00),
       (4, 'ECG', 80.00),
       (5, 'Vaccination', 60.00);
...
VALUES (1, 1, 100.00), -- Consultation
